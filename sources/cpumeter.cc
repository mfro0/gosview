//
// originally part of xosview sources, adapted for MiNT by Markus Fröschle, mfro@mubf.de
// Copyright (c) 2021. Original Copyright text below.
...
static const char STATFILENAME[] = "/kern/stat";
...
void CPUMeter::checkResources(void)
{
    ...
    const unsigned long usercolor = G_BLUE;
    const unsigned long nicecolor = G_YELLOW;
    const unsigned long syscolor = G_RED;
    const unsigned long idlecolor = G_LGREEN;
